...
final class USBuilder {
	...
	public function init_builder_page() {
		...
		$text_translations = array(
			'editing_not_supported' => __( 'Editing of this element is not supported.', 'us' ) . sprintf( '<br><a href="%s" target="_blank">%s</a>', $edit_post_link, __( 'Edit page in Backend', 'us' ) ),
			...
			'site_settings_updated' => us_translate( 'Changes saved.' ) . ' ' . sprintf( '<a href="%s" target="_blank">%s</a>', $post_link, us_translate( 'View Page' ) ),
